...
/**
 * Selects globals to freeze using the multi-select field.
 *
 * @param page - The Playwright page instance
 * @param slugs - Array of global slugs to select
 *
 * @remarks
 ...
 */
export const selectGlobals = async (page: Page, slugs: string[]) => {
	const selectControl = page.locator("#field-globals .rs__control");
