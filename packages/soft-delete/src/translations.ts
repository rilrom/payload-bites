...
export const translations = {
  ar: {
    softDelete: {
      ...
      restore: "استعادة",
      softDelete: "حذف ناعم",
      viewDocuments: "عرض مستندات {{type}}",
      active: "نشط",
      deleted: "محذوف",
    },
  },
  az: {
    softDelete: {
      ...
      viewDocuments: "{{type}} Sənədlərinə Bax",
      active: "Aktiv",
      deleted: "Silinmiş",
    },
  },
  bg: {
    softDelete: {
      ...
      viewDocuments: "Преглед на документи {{type}}",
      active: "Активен",
      deleted: "Изтрит",
    },
  },
  ca: {
    softDelete: {
      ...
      viewDocuments: "Veure documents de {{type}}",
      active: "Actiu",
      deleted: "Eliminat",
    },
  },
  cs: {
    softDelete: {
      ...
      viewDocuments: "Zobrazit dokumenty {{type}}",
      active: "Aktivní",
      deleted: "Smazáno",
    },
  },
  da: {
    softDelete: {
      ...
      viewDocuments: "Se {{type}} dokumenter",
      active: "Aktiv",
      deleted: "Slettet",
    },
  },
  de: {
    softDelete: {
      ...
      viewDocuments: "{{type}} Dokumente anzeigen",
      active: "Aktiv",
      deleted: "Gelöscht",
    },
  },
  en: {
    softDelete: {
      ...
      viewDocuments: "View {{type}} Documents",
      active: "Active",
      deleted: "Deleted",
    },
  },
  es: {
    softDelete: {
      ...
      viewDocuments: "Ver documentos de {{type}}",
      active: "Activo",
      deleted: "Eliminado",
    },
  },
  et: {
    softDelete: {
      ...
      viewDocuments: "Vaata {{type}} dokumente",
      active: "Aktiivne",
      deleted: "Kustutatud",
    },
  },
  fa: {
    softDelete: {
      ...
      restore: "بازیابی",
      softDelete: "حذف نرم",
      viewDocuments: "مشاهده {{type}} اسناد",
      active: "فعال",
      deleted: "حذف شده",
    },
  },
  fr: {
    softDelete: {
      ...
      viewDocuments: "Voir les documents {{type}}",
      active: "Actif",
      deleted: "Supprimé",
    },
  },
  he: {
    softDelete: {
      ...
      viewDocuments: "הצג את המסמכים {{type}}",
      active: "פעיל",
      deleted: "נמחק",
    },
  },
  hr: {
    softDelete: {
      ...
      restore: "Obnovi",
      softDelete: "Soft delete",
      viewDocuments: "Pogledaj {{type}} dokumente",
      active: "Aktivno",
      deleted: "Obrisano",
    },
  },
  hu: {
    softDelete: {
      ...
      viewDocuments: "Dokumentumok megtekintése {{type}}",
      active: "Aktív",
      deleted: "Törölt",
    },
  },
  it: {
    softDelete: {
      ...
      viewDocuments: "Visualizza documenti {{type}}",
      active: "Attivo",
      deleted: "Eliminato",
    },
  },
  ...
  my: {
    softDelete: {
      ...
      viewDocuments: "Lihat Dokumen {{type}}",
      active: "Aktif",
      deleted: "Dipadam",
    },
  },
  nb: {
    softDelete: {
      ...
      viewDocuments: "Vis {{type}} dokumenter",
      active: "Aktiv",
      deleted: "Slettet",
    },
  },
  nl: {
    softDelete: {
      ...
      viewDocuments: "Bekijk {{type}} documenten",
      active: "Actief",
      deleted: "Verwijderd",
    },
  },
  pl: {
    softDelete: {
      ...
      viewDocuments: "Zobacz dokumenty {{type}}",
      active: "Aktywny",
      deleted: "Usunięty",
    },
  },
  pt: {
    softDelete: {
      ...
      viewDocuments: "Ver documentos {{type}}",
      active: "Ativo",
      deleted: "Excluído",
    },
  },
  ro: {
    softDelete: {
      ...
      viewDocuments: "Vizualizează documentele {{type}}",
      active: "Activ",
      deleted: "Șters",
    },
  },
  ...
  ru: {
    softDelete: {
      ...
      viewDocuments: "Просмотр документов {{type}}",
      active: "Активно",
      deleted: "Удалено",
    },
  },
  sk: {
    softDelete: {
      ...
      viewDocuments: "Zobraziť dokumenty {{type}}",
      active: "Aktívne",
      deleted: "Odstránené",
    },
  },
  sl: {
    softDelete: {
      ...
      viewDocuments: "Ogled dokumentov {{type}}",
      active: "Aktivno",
      deleted: "Izbrisano",
    },
  },
  sv: {
    softDelete: {
      ...
      viewDocuments: "Visa {{type}} dokument",
      active: "Aktiv",
      deleted: "Borttagen",
    },
  },
  ...
  tr: {
    softDelete: {
      ...
      viewDocuments: "{{type}} belgelerini görüntüle",
      active: "Aktif",
      deleted: "Silindi",
    },
  },
  uk: {
    softDelete: {
      ...
      viewDocuments: "Переглянути документи {{type}}",
      active: "Активно",
      deleted: "Видалено",
    },
  },
  vi: {
    softDelete: {
      ...
      restore: "Khôi phục",
      softDelete: "Xóa mềm",
      viewDocuments: "Xem tài liệu {{type}}",
      active: "Hoạt động",
      deleted: "Đã xóa",
    },
  },
