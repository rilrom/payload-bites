...
export const translations = {
	...
	bnBd: {
		softDelete: {
			deletedCountSuccessfully:
				"{{count}} {{label}} সফলভাবে সফট ডিলিট করা হয়েছে।",
	...
	id: {
		softDelete: {
			deletedCountSuccessfully:
				"{{count}} {{label}} berhasil dihapus sementara.",
			...
			restoringTitle:
				"Terjadi kesalahan saat memulihkan {{title}}. Silakan periksa koneksi Anda dan coba lagi.",
			restore: "Pulihkan",
	...
	is: {
		softDelete: {
			...
			deletingTitle:
				"Villa kom upp við að mjúkeyða {{title}}. Vinsamlegast athugaðu tenginguna þína og reyndu aftur.",
			restoringTitle:
	...
	lt: {
		softDelete: {
			deletedCountSuccessfully:
				"{{count}} {{label}} sėkmingai švelniai ištrinta.",
			...
			deletingTitle:
				"Įvyko klaida švelniai trinant {{title}}. Patikrinkite ryšį ir bandykite dar kartą.",
			restoringTitle:
				"Įvyko klaida atkuriant {{title}}. Patikrinkite ryšį ir bandykite dar kartą.",
			restore: "Atkurti",
	...
	lv: {
		softDelete: {
			...
			deletingTitle:
				"Mīksti dzēšot {{title}}, radās kļūda. Lūdzu, pārbaudiet savienojumu un mēģiniet vēlreiz.",
			restoringTitle:
				"Atjaunojot {{title}}, radās kļūda. Lūdzu, pārbaudiet savienojumu un mēģiniet vēlreiz.",
			restore: "Atjaunot",
	...
	ta: {
		softDelete: {
			deletedCountSuccessfully:
				"{{count}} {{label}} வெற்றிகரமாக மென்மையாக நீக்கப்பட்டது.",
			titleDeleted: '{{label}} "{{title}}" வெற்றிகரமாக மென்மையாக நீக்கப்பட்டது.',
			restoredCountSuccessfully:
				"{{count}} {{label}} வெற்றிகரமாக மீட்டெடுக்கப்பட்டது.",
